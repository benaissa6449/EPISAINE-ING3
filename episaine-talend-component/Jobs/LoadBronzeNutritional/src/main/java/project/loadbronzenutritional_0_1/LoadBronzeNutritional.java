...
package project.loadbronzenutritional_0_1;
...
/**
 * Job: LoadBronzeNutritional Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class LoadBronzeNutritional implements TalendJob {
...
public String getSource(){
	...
	private final String jobName = "LoadBronzeNutritional";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LoadBronzeNutritional.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadBronzeNutritional.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "INFO","","LoadBronzeNutritional begin","", "");
	globalMap.put("tWarn_1_WARN_MESSAGES", "LoadBronzeNutritional begin"); 
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PROJECT_LoadBronzeNutritional = new byte[0];
    static byte[] commonByteArray_PROJECT_LoadBronzeNutritional = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJECT_LoadBronzeNutritional) {
...
final String applicationName_tMongoDBOutput_1 = "Talend";
    ...
    int nb_line_tMongoDBOutput_1 = 0;
            ...
            java.util.Map<String, String> pathMap_tMongoDBOutput_1=new java.util.HashMap<>();
                ...
                pathMap_tMongoDBOutput_1.put("dummy","");
    ...
    com.mongodb.client.MongoDatabase db_tMongoDBOutput_1=null;
        ...
        db_tMongoDBOutput_1.getCollection(context.mongodb_collection_bronze_nutritional).drop();
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_1 = db_tMongoDBOutput_1.getCollection(context.mongodb_collection_bronze_nutritional);
...
try{
				updateObjectUtil_tMongoDBOutput_1.setObject(new org.bson.Document());
					...
					int countKey_tMongoDBOutput_1=0;
                                        ...
                                        updateObjectUtil_tMongoDBOutput_1.put(pathMap_tMongoDBOutput_1.get("dummy"),"dummy", row3.dummy);
				org.bson.Document updateObj_tMongoDBOutput_1 = updateObjectUtil_tMongoDBOutput_1.getObject();
					...
					if(countKey_tMongoDBOutput_1 <=0){
						...
						org.bson.Document queryObj_tMongoDBOutput_1 = queryObjectUtil_tMongoDBOutput_1.getObject();
									...
									coll_tMongoDBOutput_1.deleteMany(queryObj_tMongoDBOutput_1);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJECT_LoadBronzeNutritional.length) {
				if(length < 1024 && commonByteArray_PROJECT_LoadBronzeNutritional.length == 0) {
   					commonByteArray_PROJECT_LoadBronzeNutritional = new byte[1024];
				} else {
   					commonByteArray_PROJECT_LoadBronzeNutritional = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJECT_LoadBronzeNutritional, 0, length);
			strReturn = new String(commonByteArray_PROJECT_LoadBronzeNutritional, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJECT_LoadBronzeNutritional, 0, length);
			strReturn = new String(commonByteArray_PROJECT_LoadBronzeNutritional, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
final String applicationName_tMongoDBOutput_2 = "Talend";
    ...
    int nb_line_tMongoDBOutput_2 = 0;
            ...
            java.util.Map<String, String> pathMap_tMongoDBOutput_2=new java.util.HashMap<>();
                ...
                pathMap_tMongoDBOutput_2.put("ID","");
                pathMap_tMongoDBOutput_2.put("Description","");
                pathMap_tMongoDBOutput_2.put("Calories","");
                pathMap_tMongoDBOutput_2.put("Protein","");
                pathMap_tMongoDBOutput_2.put("TotalFat","");
                pathMap_tMongoDBOutput_2.put("Carbohydrate","");
                pathMap_tMongoDBOutput_2.put("Sodium","");
                pathMap_tMongoDBOutput_2.put("SaturatedFat","");
                pathMap_tMongoDBOutput_2.put("Cholesterol","");
                pathMap_tMongoDBOutput_2.put("Sugar","");
                pathMap_tMongoDBOutput_2.put("Calcium","");
                pathMap_tMongoDBOutput_2.put("Iron","");
                pathMap_tMongoDBOutput_2.put("Potassium","");
                pathMap_tMongoDBOutput_2.put("VitaminC","");
                pathMap_tMongoDBOutput_2.put("VitaminE","");
                pathMap_tMongoDBOutput_2.put("VitaminD","");
    ...
    com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBOutput_2 = db_tMongoDBOutput_2.getCollection(context.mongodb_collection_bronze_nutritional);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.nutrition_dataset/** End field tFileInputDelimited_1:FILENAME */;		
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							row1.Carbohydrate = null;
					
							row1.Sodium = null;
					
							row1.SaturatedFat = null;
					
							row1.Cholesterol = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Calories = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Protein = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.TotalFat = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Carbohydrate = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Sodium = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.SaturatedFat = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Cholesterol = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Sugar = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Calcium = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Iron = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.Potassium = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.VitaminC = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.VitaminE = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.VitaminD = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
try{
				updateObjectUtil_tMongoDBOutput_2.setObject(new org.bson.Document());
                                        ...
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("ID"),"ID", row1.ID);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Description"),"Description", row1.Description);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Calories"),"Calories", row1.Calories);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Protein"),"Protein", row1.Protein);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("TotalFat"),"TotalFat", row1.TotalFat);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Carbohydrate"),"Carbohydrate", row1.Carbohydrate);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Sodium"),"Sodium", row1.Sodium);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("SaturatedFat"),"SaturatedFat", row1.SaturatedFat);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Cholesterol"),"Cholesterol", row1.Cholesterol);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Sugar"),"Sugar", row1.Sugar);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Calcium"),"Calcium", row1.Calcium);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Iron"),"Iron", row1.Iron);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("Potassium"),"Potassium", row1.Potassium);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("VitaminC"),"VitaminC", row1.VitaminC);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("VitaminE"),"VitaminE", row1.VitaminE);
                                        updateObjectUtil_tMongoDBOutput_2.put(pathMap_tMongoDBOutput_2.get("VitaminD"),"VitaminD", row1.VitaminD);
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "INFO","","LoadBronzeNutritional end","", "");
	globalMap.put("tWarn_2_WARN_MESSAGES", "LoadBronzeNutritional end"); 
 ...
 */
    ...
    public static void main(String[] args){
        final LoadBronzeNutritional LoadBronzeNutritionalClass = new LoadBronzeNutritional();

        int exitCode = LoadBronzeNutritionalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadBronzeNutritional.class.getClassLoader().getResourceAsStream("project/loadbronzenutritional_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadBronzeNutritional.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadBronzeNutritional");
        }
...
/************************************************************************************************
 *     113412 characters generated by Talend Open Studio for Big Data 
 *     on the 27 février 2026, 02:11:04 CET
 ************************************************************************************************/