...
BRONZE_COLLECTION = os.getenv("BRONZE_COLLECTION", "episaine_bronze_k")
SILVER_COLLECTION = os.getenv("SILVER_COLLECTION", "episaine_silver_k")
GOLD_COLLECTION = os.getenv("GOLD_COLLECTION", "episaine_gold_k")
