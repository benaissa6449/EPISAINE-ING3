package fr.upec.sirius.episaine.episaine_cache_loader.data.model;

import java.sql.Timestamp;
import java.util.List;

import fr.upec.sirius.episaine.episaine_cache_loader.data.enums.CustomerGender;
import fr.upec.sirius.episaine.episaine_cache_loader.data.enums.CustomerPreferedContact;
import fr.upec.sirius.episaine.episaine_cache_loader.data.enums.CustomerWeightGoal;
...
@Entity
@Data
@Table(name = "customers_demo", schema = "gold")
@AllArgsConstructor
@NoArgsConstructor
